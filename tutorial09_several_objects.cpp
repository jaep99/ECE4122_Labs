...
int main( void )
{
	...
	do{
        ...
        ModelMatrix1 = glm::translate(ModelMatrix1, glm::vec3(0.0f, 1.0f, 1.9f));
        ...
        ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(0.0f, 1.0f, 1.9f));
        ...
        ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, 1.0f, 1.9f));
        ...
        ModelMatrix4 = glm::translate(ModelMatrix4, glm::vec3(0.0f, 1.0f, 1.9f));
